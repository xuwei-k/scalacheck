...
private[scalacheck] trait GenArities{
  ...
  def zip[T1,T2](
    ...
    val g = g1.flatMap((t1: T1) => g2.map { t2 => (t1, t2) })
    g.suchThat {
      case (t1, t2) =>
  ...
  def zip[T1,T2,T3](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.map { t3 => (t1, t2, t3) }))
    g.suchThat {
      case (t1, t2, t3) =>
  ...
  def zip[T1,T2,T3,T4](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.map { t4 => (t1, t2, t3, t4) })))
    g.suchThat {
      case (t1, t2, t3, t4) =>
  ...
  def zip[T1,T2,T3,T4,T5](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.map { t5 => (t1, t2, t3, t4, t5) }))))
    g.suchThat {
      case (t1, t2, t3, t4, t5) =>
  ...
  def zip[T1,T2,T3,T4,T5,T6](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.flatMap((t5: T5) => g6.map { t6 => (t1, t2, t3, t4, t5, t6) })))))
    g.suchThat {
  ...
  def zip[T1,T2,T3,T4,T5,T6,T7](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.flatMap((t5: T5) => g6.flatMap((t6: T6) => g7.map { t7 => (t1, t2, t3, t4, t5, t6, t7) }))))))
    g.suchThat {
  ...
  def zip[T1,T2,T3,T4,T5,T6,T7,T8](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.flatMap((t5: T5) => g6.flatMap((t6: T6) => g7.flatMap((t7: T7) => g8.map { t8 => (t1, t2, t3, t4, t5, t6, t7, t8) })))))))
    g.suchThat {
  ...
  def zip[T1,T2,T3,T4,T5,T6,T7,T8,T9](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.flatMap((t5: T5) => g6.flatMap((t6: T6) => g7.flatMap((t7: T7) => g8.flatMap((t8: T8) => g9.map { t9 => (t1, t2, t3, t4, t5, t6, t7, t8, t9) }))))))))
    g.suchThat {
  ...
  def zip[T1,T2,T3,T4,T5,T6,T7,T8,T9,T10](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.flatMap((t5: T5) => g6.flatMap((t6: T6) => g7.flatMap((t7: T7) => g8.flatMap((t8: T8) => g9.flatMap((t9: T9) => g10.map { t10 => (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10) })))))))))
    g.suchThat {
  ...
  def zip[T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.flatMap((t5: T5) => g6.flatMap((t6: T6) => g7.flatMap((t7: T7) => g8.flatMap((t8: T8) => g9.flatMap((t9: T9) => g10.flatMap((t10: T10) => g11.map { t11 => (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11) }))))))))))
    g.suchThat {
  ...
  def zip[T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.flatMap((t5: T5) => g6.flatMap((t6: T6) => g7.flatMap((t7: T7) => g8.flatMap((t8: T8) => g9.flatMap((t9: T9) => g10.flatMap((t10: T10) => g11.flatMap((t11: T11) => g12.map { t12 => (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12) })))))))))))
    g.suchThat {
  ...
  def zip[T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.flatMap((t5: T5) => g6.flatMap((t6: T6) => g7.flatMap((t7: T7) => g8.flatMap((t8: T8) => g9.flatMap((t9: T9) => g10.flatMap((t10: T10) => g11.flatMap((t11: T11) => g12.flatMap((t12: T12) => g13.map { t13 => (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13) }))))))))))))
    g.suchThat {
  ...
  def zip[T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13,T14](
    ...
    val g = g1.flatMap((t1: T1) => g2.flatMap((t2: T2) => g3.flatMap((t3: T3) => g4.flatMap((t4: T4) => g5.flatMap((t5: T5) => g6.flatMap((t6: T6) => g7.flatMap((t7: T7) => g8.flatMap((t8: T8) => g9.flatMap((t9: T9) => g10.flatMap((t10: T10) => g11.flatMap((t11: T11) => g12.flatMap((t12: T12) => g13.flatMap((t13: T13) => g14.map { t14 => (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14) })))))))))))))
    g.suchThat {
